...
export const metadata = pageMetadata({
  ...
  path: "/",
  keywords: ["aviation institute India", "cabin crew academy", "placement support"],
});
    ...
    <>
      ...
      <section className={cn(heroSurface, heroPad)}>
        ...
        >
          <div>
            ...
            <h1 className="mt-5.5 text-[clamp(40px,5.4vw,68px)] font-semibold max-phablet:text-[clamp(31px,8.4vw,46px)]">
              Train for the skies.
              <br />
              <em className="text-haze not-italic">Build a new nation.</em>
            </h1>
            <p className={lede}>
              Emporium prepares India&apos;s next generation of cabin crew, airport
              ground staff and hospitality professionals — with industry-current
              training, grooming and dedicated placement support.
            </p>
            <div className="mt-[34px] flex flex-wrap gap-3.5 max-phablet:mt-7 max-phablet:flex-col max-phablet:items-stretch max-phablet:gap-3">
            ...
            <div className="mt-6.5 flex flex-wrap gap-5.5 font-mono text-[13.5px] text-[#93a2d6] max-phablet:gap-x-[18px] max-phablet:gap-y-2.5 max-phablet:text-[12.5px]">
              <span className="flex items-center gap-2">
                <i className="size-[7px] rounded-full bg-green shadow-[0_0_0_4px_rgba(62,207,142,0.18)]" />{" "}
                Admissions open
              </span>
              <span className="flex items-center gap-2">6 career-ready programs</span>
              <span className="flex items-center gap-2">Placement cell on campus</span>
            </div>
          </div>
      ...
      <section className={cn("bg-paper", sectionPad)} id="why">
        <div className={wrap}>
          ...
          >
            Skilling is nation-building. Every course at Emporium is built to turn
            ambition into an interview-ready, world-ready professional — not just a
            certificate.
          </SectionHead>
          <PillarGrid />
        </div>
      ...
      {/* ============ PROGRAMS ============ */}
      <section
        className={cn("bg-[linear-gradient(180deg,#fff,var(--paper))]", sectionPad)}
        id="programs"
      >
        <div className={wrap}>
          <SectionHead
          ...
          >
            Each program is your boarding pass into a specific role. Pick the one
            that matches where you want to land.
          </SectionHead>
      ...
      <section className={cn("bg-paper", sectionPad)} id="placements">
        <div className={wrap}>
          <SectionHead eyebrow="Placements & alumni" title="The window seat, earned.">
            Our placement cell runs drives, referrals and interview prep year-round.
            Here&apos;s the kind of journey Emporium is built to support.
          </SectionHead>
          <StoryGrid />
      ...
      <section className={cn("bg-white", sectionPad)} id="admit">
        <div className={wrap}>
          <SectionHead eyebrow="Admissions" title="Four steps to boarding.">
            A simple, guided path from your first enquiry to your first day on the
            job.
          </SectionHead>
          <AdmissionSteps />
        </div>
