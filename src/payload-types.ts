...
export interface Post {
  ...
  title: string;
  /**
   * The URL for this post. Changing it breaks inbound links.
   */
  slug: string;
  publishedAt: string;
  /**
   * Optional. Posts without one fall back to a branded tile.
   */
...
export interface News {
  ...
  title: string;
  /**
   * Optional. Kept for reference; the accordion does not print it.
   */
