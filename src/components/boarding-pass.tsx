  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="h-7 max-w-30 mx-auto flex-1 rounded-xs bg-[repeating-linear-gradient(90deg,#fff_0_2px,transparent_2px_4px,#fff_4px_5px,transparent_5px_9px)] opacity-85"
          aria-hidden="true"
        />
